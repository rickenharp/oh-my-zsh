...
@wget --no-check-certificate https://github.com/rickenharp/oh-my-zsh/raw/master/tools/install.sh -O - | sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/rickenharp/oh-my-zsh.git ~/.oh-my-zsh@
...
* "View our growing list of contributors":https://github.com/rickenharp/oh-my-zsh/contributors
